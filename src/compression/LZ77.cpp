...
void LZ77Compression::compress(const string& inputFile, const string& outputFile) {
...
void LZ77Compression::decompress(const string& inputFile, const string& outputFile) {
    vector<uint8_t> inputData = fileManager.readFile(inputFile);
    vector<uint8_t> outputData;
    size_t i = 0;
